...
Then we used hyperdrive to tune the inverse regularization paramter(regularization strength) & the maximum number of iterations in order to maximize the value of the accuracy. The best values were found to be: 'Regularization Strength:': 0.5858899974655808, 'Max iterations:': 20, 'Accuracy': 0.9072837632776934.
